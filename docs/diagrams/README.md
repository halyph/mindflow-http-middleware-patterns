...
| **5** | [scenario-5-retry-5xx.md](scenario-5-retry-5xx.md) | 5xx errors → retry → cache |
| **6** | [scenario-6-timeout-demo.md](scenario-6-timeout-demo.md) | Client timeout (context cancelled - NOT retried) |
